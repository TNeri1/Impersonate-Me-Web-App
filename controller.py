...
from iPERCore.iPERCore.services.options.options_setup import setup
from iPERCore.iPERCore.services.run_imitator import run_imitator



def converter(pic_path, videopath):
###############################################################################################
##                   Setting
###############################################################################################
    ...
    resultpath = "./media/products/" + model_id+ "-" + pc_id + ".mp4"
